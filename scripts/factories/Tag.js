class Tag {
  constructor(templateTagSelector, category) {
    const blockTag = document.querySelector(".header__block-tag")
    const item = templateTagSelector.querySelectorAll(`.header__tag-choice p`);
    ...
    item.forEach((element) => {
      element.addEventListener("click", (event) => {
        ...
        svg.addEventListener("click", () => blockTag.removeChild(templateTag));
